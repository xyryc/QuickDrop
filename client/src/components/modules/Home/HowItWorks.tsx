...
const steps = [
  {
    ...
    description:
      "Easily book your parcel delivery through our simple and intuitive online form.",
  },
  {
    icon: <Truck className="h-12 w-12 text-[#FF771A]" />,
    title: "2. We Pick It Up",
    description:
      "Our professional delivery team will collect the parcel from your location as scheduled.",
  },
  {
    icon: <CheckCircle className="h-12 w-12 text-[#FF771A]" />,
    title: "3. Delivered to Your Door",
    description:
      "We ensure safe and timely delivery of your parcel to the recipient's address.",
  },
];
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-[#FFE2C6] via-white to-[#FFB877]/60 dark:from-[#24252A] dark:to-[#FF771A]/15 transition-colors">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl font-extrabold mb-4 tracking-tight lg:text-5xl text-[#FF771A]">
          How It Works
        </h2>
        <p className="max-w-2xl mx-auto text-[#24252A] dark:text-white mb-12 text-lg font-medium">
          Our process is simple and transparent. Follow these easy steps to get
        ...
        <div className="relative flex flex-col md:flex-row justify-center items-stretch gap-8 min-h-[340px]">
          {steps.map((step, index) => (
            ...
            >
              <Card
                className={`flex flex-col items-center p-7 text-center shadow-2xl border-0
