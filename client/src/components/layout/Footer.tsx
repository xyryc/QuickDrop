      ...
      <div className="container mx-auto py-12 md:py-16 px-4">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-md mb-6">
            Subscribe to our newsletter and never miss an update on our services
            and special offers.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 border-t border-muted pt-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <Link to="/" className="text-primary text-primary/90 mb-4">
              {/* Example SVG logo */}
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>
                <Link to="/contact" className="text-primary transition-colors">
                  Contact
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-primary transition-colors">
                  Careers
                </Link>
              </li>
              <li>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              {/* <li><Link to="#" className="text-primary transition-colors">Live Chat</Link></li> */}
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-4 border-t border-muted text-center text-sm text-muted-foreground flex flex-col md:flex-row items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              className="font-semibold text-orange-600 text-orange-800 transition-colors underline underline-offset-2"
