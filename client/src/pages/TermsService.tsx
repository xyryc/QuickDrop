        ...
        <Card className="shadow-md border-0 rounded-2xl bg-gradient-to-r from-orange-100 to-green-50 dark:from-gray-900 dark:to-green-950 mb-8">
          <CardHeader>
            ...
            <CardDescription className="text-lg text-gray-800 dark:text-gray-100">
              Please review our terms and conditions for using Logisti Core. We
              aim for transparency and trust.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <section className="mb-6">
              <h2 className="text-xl font-bold text-orange-700 dark:text-orange-300 mb-2">
                1. Acceptance of Terms
              </h2>
              <p className="text-gray-700 dark:text-gray-200">
                By accessing or using Logisti Core, you agree to be bound by
            ...
            <section className="mb-6">
              ...
              <ul className="list-disc ml-6 text-gray-700 dark:text-gray-200">
                <li>
                  ...
                  registration and parcel booking.
                </li>
            ...
            <section className="mb-6">
              ...
              <ul className="list-disc ml-6 text-gray-700 dark:text-gray-200">
                ...
                <li>
                  Logisti Core is not responsible for delays due to
                  circumstances beyond our control.
                </li>
                <li>
                  We reserve the right to suspend accounts violating our
                  policies.
                </li>
              </ul>
            </section>
            <section className="mb-6">
              ...
              <p className="text-gray-700 dark:text-gray-200">
                Your data is protected as per our Privacy Policy. We do not sell
            ...
            <section className="mb-6">
              ...
              <p className="text-gray-700 dark:text-gray-200">
                Logisti Core may update these Terms of Service at any time.
