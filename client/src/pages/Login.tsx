    ...
    <div className="grid min-h-screen lg:grid-cols-2 bg-gradient-to-tr from-gray-50 to-green-100 dark:from-gray-900 dark:to-green-950">
      ...
      <div className="relative hidden lg:block overflow-hidden group">
        <img
          ...
          className="absolute inset-0 h-full w-full object-cover rounded-l-3xl shadow-2xl transition-transform duration-500 group-scale-105 group-brightness-90 group-saturate-150"
        />
        {/* Overlay for hover */}
        ...
        <div className="absolute top-10 right-10 w-10 h-10 bg-green-300/50 rounded-full blur-lg group-scale-125 transition duration-500" />
